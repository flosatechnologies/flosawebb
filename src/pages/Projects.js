        ...
        <Row className="first">
          <Col id="phase1">
            ...
            >
              ...
              <a href="https://3wishesgh.com" target="_blank" rel="noreferrer">Visit Vees Oven Gh</a> </p>
              </BackSide>
            </Flippy>
          </Col>
          <Col>
            <Flippy
              ...
              <h5 id="title">Vees Oven Gh</h5>
              <p id="text">Vees Oven is a local bakery business specialized in cakes and other pasteries of all types.<br/>
              <a href="https://blessdelconstruction.com" target="_blank" rel="noreferrer">Visit Vees Oven Gh</a> </p>
              </BackSide>
            </Flippy>
          </Col>
          <Col id="phase1">

          ...
          <div className="row align-items-center  ">
            ...
            <div className="col-md para-area ">
              <p className="text-para">
                ...
                FLOSA Technologies handles mobile application development from
          ...
          <div className="row align-items-center justify-content-between ">
            ...
            <div className="col-md para-area">
              <p className="text-para">
                ...
                corporate, news & magazine, portfolio, just to mention a few.
              </p>
              <p className="text-para">
                <span className="icon">
                  <CheckCircleFill color="#47a2fc" size={25} />
              ...
              <p className="text-para">
                ...
                We provide responsive web solutions so that for any device these
                solutions are well laid out.
              </p>
              <p className="text-para">
                <span className="icon">
                  <CheckCircleFill color="#47a2fc" size={25} />
          ...
          <div className="row align-items-center justify-content-between ">
            ...
            <div className="col-md para-area">
              <p className="text-para">
                ...
                If you have you need a software solution to meet your specific
                business needs we are just right for you.
              </p>
              <p className="text-para">
                <span className="icon">
                  <CheckCircleFill color="#47a2fc" size={25} />
